  ...
  return {
    ...
    data: {
      ...
      accounts: [
        ...
        { value: 'A002', label: 'A002 · 主力 IP 大盘户' },
        { value: 'A005', label: 'A005 · 古言短剧扩量户' },
