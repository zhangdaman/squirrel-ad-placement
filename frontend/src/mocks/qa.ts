...
const SCRIPTS: Record<QaFlow, () => QaAnswerScript> = {
  ...
  bid: () => ({
    ...
    blocks: [
      ...
      },
      {
        kind: 'sources',
        refs: [
          SRC('sop-v2', '📘 智能放量阶段出价调整 SOP'),
          SRC('q1-report', '📊 双女主题材放量复盘（5 月）'),
          SRC('bench-2024q4', '📊 腾讯广告 · 视频号短剧 ROI 基准 2025 Q1'),
  ...
  reject: () => ({
    ...
    blocks: [
      ...
      {
        kind: 'sources',
        refs: [SRC('audit-v3-2', '🛡️ 巨量引擎 · 短剧广告审核新规 v3.2'), SRC('reject-history', '📘 巨量拒审申诉话术库')],
      },
      metaBar('⏱ 4.1 秒 · 置信度 91%'),
    ],
    sources: [SRC('audit-v3-2', '🛡️ 巨量引擎 · 短剧广告审核新规 v3.2'), SRC('reject-history', '📘 巨量拒审申诉话术库')],
  }),
    ...
    blocks: [
      ...
      },
      {
        ...
        refs: [
          ...
          SRC('bench-industry', '📊 磁力金牛 · 行业 CPM 基准 2025 Q1'),
          SRC('a001-history', '📊 A001 旗舰户 5 月 ROI 滑坡复盘'),
        ],
      },
  ...
  knowledge: () => ({
    ...
    blocks: [
      ...
      { kind: 'sources', label: '原文来源', refs: [SRC('audit-v3-2', '🛡️ 巨量引擎 · 短剧广告审核新规 v3.2')] },
      metaBar('⏱ 0.6 秒 · 直接命中规则库', true, false),
    ],
    sources: [SRC('audit-v3-2', '🛡️ 巨量引擎 · 短剧广告审核新规 v3.2')],
  }),
  ...
  /* CHK：跨平台规则对比 —— 巨量过了腾讯被拒 */
  cross_platform: () => ({
    intent: { intent: '跨平台规则对比', style: 'ASK-02', layer: 'L1' },
    steps: ['命中跨平台审核差异知识库', '比对巨量 v3.2 与腾讯优量汇审核要点 对应条款'],
    blocks: [
      {
        kind: 'toolCall',
        head: '🔧 已调用「跨平台规则对比」能力…',
        items: [
          '✓ 拉取巨量审核规则 v3.2 与腾讯优量汇审核要点',
      ...
      },
      {
        kind: 'sources',
        refs: [
          SRC('audit-v3-2', '🛡️ 巨量引擎 · 短剧广告审核新规 v3.2'),
          SRC('gdt-audit', '🛡️ 腾讯广告 · 优量汇短剧素材审核要点'),
        ],
      },
    ...
    blocks: [
      ...
      },
      {
        ...
        refs: [
          SRC('sop-v2', '📘 智能放量阶段出价调整 SOP'),
          SRC('q1-report', '📊 双女主题材放量复盘（5 月）'),
          SRC('exp-targeting', '📘 巨量引擎 · 千川短剧起量定向包配置规范'),
        ],
      },
  ...
  creative: () => ({
    ...
    blocks: [
      ...
      },
      {
        kind: 'sources',
        refs: [
          SRC('exp-creative', '📘 信息流竖版素材 · 黄金 5 秒分镜模板'),
          SRC('q1-report', '📊 双女主题材放量复盘（5 月）'),
        ],
      },
    ...
    blocks: [
      ...
      },
      {
        ...
        refs: [
          SRC('sop-v2', '📘 智能放量阶段出价调整 SOP'),
          SRC('a001-history', '📊 A001 旗舰户 5 月 ROI 滑坡复盘'),
          SRC('exp-budget', '📊 智能放量 · 跑量计划阶梯加价表 v2'),
        ],
      },
...
const SOURCE_MAP: Record<string, SourceDetail> = {
  'sop-v2': {
    ...
    title: '智能放量阶段出价调整 SOP', subtitle: '私域 · L3 · AI 沉淀',
    tags: [{ cls: 'prv-ai', text: '🤖 AI 沉淀' }, { cls: 'gray', text: 'L3 团队' }, { cls: 'confidence', text: '命中率 81%' }],
    chunkId: 'CHUNK_001', chunkTokens: 356, citedTimes: 78,
    chunk: '"放量首日：基础出价 × 1.1；ROI 低于 0.8 时立即降至 ×0.9，且暂停放量观察 4 小时再决定是否复投 …"',
    meta: { 来源类型: 'AI 自动沉淀（复盘 Agent × 5 次）', 审核人: '钱晓彤 · 投放主管', 沉淀时间: '2026-05-29 09:12', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 78, 命中率: '81%', 点赞: 54 },
  },
  'q1-report': {
    id: 'q1-report', icon: '📊', iconClass: 't-case',
    title: '双女主题材放量复盘（5 月）', subtitle: '私域 · L3 团队 · 上传',
    tags: [{ cls: 'prv-up', text: '🔒 私域' }, { cls: 'gray', text: 'L3 团队' }, { cls: 'confidence', text: '命中率 77%' }],
    chunkId: 'CHUNK_001', chunkTokens: 376, citedTimes: 35,
    chunk: '"双女主起量关键：前 3 天不加莱卡包，纯用系统智能 + 行为兴趣，转化跑稳后第 4 天叠加相似人群 …"',
    meta: { 来源类型: '半结构化文档（复盘 PDF · 12 页）', 上传人: '李响 · 投手', 上传时间: '2026-05-27 10:18', 归档时间: '2026-05-27', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 35, 命中率: '77%', 点赞: 29 },
  },
  'bench-2024q4': {
    id: 'bench-2024q4', icon: '📊', iconClass: 't-bench',
    title: '腾讯广告 · 视频号短剧 ROI 基准 2025 Q1', subtitle: '公域 · L2 行业经验',
    tags: [{ cls: 'pub', text: '🌐 公域' }, { cls: 'gray', text: 'L2 公域' }, { cls: 'confidence', text: '命中率 79%' }],
    chunkId: 'CHUNK_001', chunkTokens: 342, citedTimes: 51,
    chunk: '"视频号都市题材首日回收基准 0.45，7 日 ROI 基准 0.95；低于基准 20% 建议核查素材与定向 …"',
    meta: { 来源类型: '平台 API 同步（腾讯广告）', 版本: '2025Q1', 同步时间: 'API 同步 · 6 天前', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 51, 命中率: '79%', 点赞: 44 },
  },
  'rt-8accounts': {
  ...
  'audit-v3-2': {
    id: 'audit-v3-2', icon: '🛡️', iconClass: 't-rule',
    title: '巨量引擎 · 短剧广告审核新规 v3.2', subtitle: '平台官方 · L1 平台规则',
    tags: [{ cls: 'pub', text: '🛡️ 平台' }, { cls: 'gray', text: 'L1 平台' }, { cls: 'confidence', text: '命中率 94%' }],
    chunkId: 'CHUNK_002', chunkTokens: 388, citedTimes: 412,
    chunk: '"禁止出现明显暗示性肢体动作、过度血腥场面（包括卡通化呈现）；男女对峙类场景须避免直接喊话挑衅形式 …"',
    meta: { 来源类型: '平台 API 同步（巨量引擎）', 版本: 'v3.2（2025-04-15 生效）', 同步频率: '每日 02:00 自动同步', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 412, 命中率: '94%', 点赞: 305 },
  },
  'reject-history': {
    id: 'reject-history', icon: '📘', iconClass: 't-case',
    title: '巨量拒审申诉话术库', subtitle: '私域 · L3 团队 · 上传',
    tags: [{ cls: 'prv-up', text: '🔒 私域' }, { cls: 'gray', text: 'L3 团队' }, { cls: 'confidence', text: '命中率 79%' }],
    chunkId: 'CHUNK_001', chunkTokens: 360, citedTimes: 44,
    chunk: '"驳回原因「低俗暗示」申诉要点：说明画面为剧情冲突需要，非性暗示；附对应分级保护说明文件 …"',
    meta: { 来源类型: '半结构化文档（申诉模板 Word · 10 页）', 上传人: '李响 · 投手', 上传时间: '2026-05-23 14:55', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 44, 命中率: '79%', 点赞: 36 },
  },
  'rt-a001': {
  ...
  'bench-industry': {
    ...
    title: '磁力金牛 · 行业 CPM 基准 2025 Q1', subtitle: '公域 · L2 行业经验',
    tags: [{ cls: 'pub', text: '🌐 公域' }, { cls: 'gray', text: 'L2 公域' }, { cls: 'confidence', text: '命中率 89%' }],
    chunkId: 'CHUNK_001', chunkTokens: 372, citedTimes: 94,
    chunk: '"短剧行业 oCPM 基准 ¥18.6，月度浮动 ±12%；超出区间 1.5 倍以上建议核查定向与素材新鲜度 …"',
    meta: { 来源类型: '平台 API 同步（磁力金牛）', 版本: '2025Q1', 同步频率: '每周一自动同步', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 94, 命中率: '89%', 点赞: 71 },
  },
  'a001-history': {
    id: 'a001-history', icon: '📊', iconClass: 't-case',
    title: 'A001 旗舰户 5 月 ROI 滑坡复盘', subtitle: '私域 · L3 团队 · 上传',
    tags: [{ cls: 'prv-up', text: '🔒 私域' }, { cls: 'gray', text: 'L3 团队' }, { cls: 'confidence', text: '命中率 81%' }],
    chunkId: 'CHUNK_001', chunkTokens: 388, citedTimes: 48,
    chunk: '"ROI 滑坡根因：4 月末扩量后莱卡包未同步更新，导致人群泛化；同期头部素材服役超 21 天出现疲软 …"',
    meta: { 来源类型: '半结构化文档（复盘 Word · 8 页）', 上传人: '钱晓彤 · 投放主管', 上传时间: '2026-05-30 16:44', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 48, 命中率: '81%', 点赞: 39 },
  },
  'exp-targeting': {
    id: 'exp-targeting', icon: '📘', iconClass: 't-rule',
    title: '巨量引擎 · 千川短剧起量定向包配置规范', subtitle: '平台官方 · L1 平台规则',
    tags: [{ cls: 'pub', text: '🛡️ 平台' }, { cls: 'gray', text: 'L1 平台' }, { cls: 'confidence', text: '命中率 91%' }],
    chunkId: 'CHUNK_001', chunkTokens: 366, citedTimes: 186,
    chunk: '"起量期优先用系统智能推荐 + 1 个行为兴趣定向包；学习期满后再叠加莱卡精准包，避免一上来就收窄 …"',
    meta: { 来源类型: '平台 API 同步（巨量引擎）', 版本: 'v1.0', 同步时间: 'API 同步 · 1 天前', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 186, 命中率: '91%', 点赞: 158 },
  },
  'exp-creative': {
    id: 'exp-creative', icon: '📘', iconClass: 't-case',
    title: '信息流竖版素材 · 黄金 5 秒分镜模板', subtitle: '私域 · L3 团队 · 上传',
    tags: [{ cls: 'prv-up', text: '🔒 私域' }, { cls: 'gray', text: 'L3 团队' }, { cls: 'confidence', text: '命中率 87%' }],
    chunkId: 'CHUNK_001', chunkTokens: 360, citedTimes: 112,
    chunk: '"第 1 秒定场 + 字幕钩子，第 2-3 秒人物反差，第 4-5 秒冲突 / 悬念，转场不超过 2 次 …"',
    meta: { 来源类型: '团队上传（PDF · 24 页）', 上传人: '钱晓彤 · 投放主管', 版本: 'v1.0', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 112, 命中率: '87%', 点赞: 98 },
  },
  'exp-budget': {
    id: 'exp-budget', icon: '📊', iconClass: 't-bench',
    title: '智能放量 · 跑量计划阶梯加价表 v2', subtitle: '私域 · L3 团队 · 上传',
    tags: [{ cls: 'prv-up', text: '🔒 私域' }, { cls: 'gray', text: 'L3 团队' }, { cls: 'confidence', text: '命中率 80%' }],
    chunkId: 'CHUNK_001', chunkTokens: 350, citedTimes: 63,
    chunk: '"累计 20 转化内不加价；20-50 转化每档 +5%；超 50 转化且 ROI 达标可 +8%，单日加价不超 2 次 …"',
    meta: { 来源类型: '团队上传（Excel）', 上传人: '李响 · 投手', 版本: 'v2.0', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 63, 命中率: '80%', 点赞: 51 },
  },
  'gdt-audit': {
    id: 'gdt-audit', icon: '🛡️', iconClass: 't-rule',
    title: '腾讯广告 · 优量汇短剧素材审核要点', subtitle: '平台官方 · L1 平台规则',
    tags: [{ cls: 'pub', text: '🛡️ 平台' }, { cls: 'gray', text: 'L1 平台' }, { cls: 'confidence', text: '命中率 80%' }],
    chunkId: 'CHUNK_001', chunkTokens: 338, citedTimes: 59,
    chunk: '"首帧禁止纯黑屏或纯文字卡；诱导性话术（如「点击领取」）需弱化，改为剧情悬念引导 …"',
    meta: { 来源类型: '平台 API 同步（腾讯广告）', 版本: 'v1.0', 同步时间: 'API 同步 · 4 天前', 索引模型: 'bge-large-zh-v1.5' },
    stats: { 被引用: 59, 命中率: '80%', 点赞: 48 },
  },
}
